...
export UVM_HOME=/xcelium23.09/tools//methodology/UVM/CDNS-1.1d/sv
...
xrun -Q -unbuffered '-timescale' '1ns/1ns' '-sysv' 'blur_3x3filter.c' '-access' '+rw' -uvmnocdnsextra -uvmhome $UVM_HOME $UVM_HOME/src/uvm_macros.svh design.sv testbench.sv  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip